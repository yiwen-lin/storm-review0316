    ...
    d.flexslider = function (j, l) {
        ...
        f = {
            ...
            directionNav: {
                setup: function () {
                    var b = d('<ul class="' +
                        e + 'direction-nav"><li><a class="' + e + 'prev " href="#">' + c.prevText + '<i class="icon-left-open-big"></i>' + '</a></li><li><a class="' + e + 'next" href="#">' + c.nextText + '<i class="icon-right-open-big"></i>' + "</a></li></ul>");
